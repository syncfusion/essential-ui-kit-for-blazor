...
namespace UI_Blocks.Components.Pages.BlocksSection.Returns.Returns1
{
    public partial class Returns1
    {
        ...
        {
            new ProductData { Product = new Product { ProductName = "Apple iPhone 15 Pro Max (256 GB) - Blue Titanium", ProductImage = "apple-iphone-15" }, OrderNumber = "#49463", ReturnTerm = new DateTime(2017, 8, 15) },
            ...
            new ProductData { Product = new Product { ProductName = "Apple AirPods (2nd Generation) with Charging Case", ProductImage = "apple-airpods" }, OrderNumber = "#50924", ReturnTerm = new DateTime(2016, 9, 18) },
            new ProductData { Product = new Product { ProductName = "Apple Watch SE GPS with Starlight Sport Band - S/M (40mm Display, Starlight Aluminium Case)", ProductImage = "apple-watch" }, OrderNumber = "#19340", ReturnTerm = new DateTime(2016, 5, 7) },
            new ProductData { Product = new Product { ProductName = "Apple MacBook Air 2024 (13.6-inch, M3, 8GB, 256GB, macOS, Space Grey)", ProductImage = "apple-macbook-air-2024" }, OrderNumber = "#36101", ReturnTerm = new DateTime(2024, 8, 16) }
        };
