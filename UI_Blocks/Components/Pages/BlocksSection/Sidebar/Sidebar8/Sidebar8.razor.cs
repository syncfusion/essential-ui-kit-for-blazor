...
namespace UI_Blocks.Components.Pages.BlocksSection.Sidebar.Sidebar8
{
    public partial class Sidebar8
    {
        ...
        public List<MenuItem> ContactList = new List<MenuItem>
        {
            new MenuItem { Id = 1, Name = "Darlene Robertson", ProfileImage = "avatar-11.jpg" },
            new MenuItem { Id = 2, Name = "Marvin McKinney", ProfileImage = "avatar-5.jpg" },
            new MenuItem { Id = 3, Name = "Ralph Edwards", ProfileImage = "avatar-3.jpg" },
            new MenuItem { Id = 4, Name = "Courtney Henry", ProfileImage = "avatar-9.jpg" },
